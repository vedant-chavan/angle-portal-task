          ...
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form id="user_registration" >
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                    <input type="tel" id="phoneNumber" name="phone_number" class="form-control form-control-lg" maxlength="10" pattern="\d{10}" />
                    <label class="form-label" for="phoneNumber">Phone Number</label>
                </div>

                <div data-mdb-input-init class="form-outline mb-4">
                    <select class="select form-control-lg" name="employee_type" >
                ...
                <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href={{route('user_login')}}
...
<script>
    ...
    $.validator.addMethod("passwordCheck", function(value, element) {
        return this.optional(element) 
            ...
            && value.length > 8;  // Max 8 characters long
    }, "Password must be at most 8 characters long, contain at least one uppercase letter and one special character.");
        ...
        submitHandler: function(form) {
          ...
          headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
              ...
              setTimeout(function () {
                window.location.href = '{{route('user_data')}}';
              }, 1000);
							form.reset();
						}else{
